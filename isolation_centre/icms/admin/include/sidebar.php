							...
							<li>
								...
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Donation </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="Money_Donation.php">
											<span class="title"> Money Donation</span>
										</a>
									</li>
									<li>
									...
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Manage Donation </span>
										</div>
									</div>
								</a>
									<ul class="sub-menu">
									<li>
										<a href="Add-Money-Donor.php ?>">
											<span class="title"> Add Money Donor</span>
										</a>
									</li>
									<li>
										<a href="Add-Blood-Donor.php">
											<span class="title"> Add Blood Donor</span>
										</a>
									</li>
								</ul>
								</li>
