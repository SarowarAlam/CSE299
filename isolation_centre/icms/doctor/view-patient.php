...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert   tblmedicalhistory(PatientID,OxygenLevel,CovidTest,Weight,Temperature,MedicalPres)value('$vid','$ol','$ct','$weight','$temp','$pres')");
    if ($query) {
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <th>Oxygen Level :</th>
    <td>
    <input name="ol" placeholder="Oxygen Level" class="form-control wd-450" required="true"></td>
  </tr>                          
     <tr>
    <th>Covid Test :</th>
    <td>
    <input name="ct" placeholder="Covid Test" class="form-control wd-450" required="true"></td>
  </tr> 
  <tr>
    <th>Weight :</th>
    <td>
